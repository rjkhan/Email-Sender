 ...
 */
  ...
  return (
	<form onSubmit={handleSubmit(onSubmit)}>
		<center><div><h2>Input Recipent</h2></div></center>

	  <input placeholder="firstName" name="firstName" ref={register({ required: true })} />
		{errors.firstName && "First name is required"}  
		<br></br>
		<input placeholder="lastName" name="lastName" ref={register({ required: true })} />
	  ...
	  <br></br>
		...
		<br></br>
		<input placeholder="disease" name="disease" ref={register} />
